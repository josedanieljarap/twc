      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center py-2">
                ...
                <span className="text-gray-600">6:00 AM - 6:00 PM</span>
              </div>
            </div>
            <div className="mt-4 p-3 bg-amber-50 rounded-lg">
              <p className="text-sm text-amber-800">
                <strong>Nota:</strong> Horarios especiales en días festivos. 
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Av. Principal 123, Ciudad, Estado 12345</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">info@panaderiamoises.com</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
            ...
            <p className="text-gray-600 mb-4">
              Encuéntranos en el corazón de la ciudad. Estamos ubicados en una zona 
              de fácil acceso con estacionamiento disponible.
            </p>
            ...
            <div className="mt-4 p-4 bg-gray-50 rounded-lg">
              <h3 className="font-semibold text-gray-800 mb-2">Cómo llegar:</h3>
              <ul className="text-sm text-gray-600 space-y-1">
                <li>• <strong>En auto:</strong> Estacionamiento gratuito disponible</li>
                <li>• <strong>En transporte público:</strong> Línea 1, estación Central</li>
                <li>• <strong>A pie:</strong> 5 minutos desde el centro comercial</li>
              </ul>
            </div>
          </div>
        </div>
